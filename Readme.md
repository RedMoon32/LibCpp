...
### Описание проекта
Консольная система управления библиотекой предназначена для управления библиотечным фондом. Система должна поддерживать различные сущности (книги, журналы, авторы, читатели), предоставлять функции поиска, сохранения и загрузки данных из файлов, а также функционал выдачи и возврата предметов.
...
Ошибка: Книга "Неизвестная книга" не найдена в библиотеке.
```
...
Ошибка: Все экземпляры книги "Преступление и наказание" уже выданы.
```
...
Введите номер читательского билета: 12345
Введите название предмета: Неизвестная книга
Ошибка: Книга "Неизвестная книга" не найдена в списке читаемых книг читателя Иван Иванов.
```
...
#### 2. Средний функционал (дополнение)
...
### Заключение
Данное техническое задание описывает основные требования к консольной системе управления библиотекой. Реализация всех уровней функциональности позволит студенту продемонстрировать свои навыки программирования на C++ и умение работать с различными структурами данных и файлами.
