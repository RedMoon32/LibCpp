...
#### 1. Главный функционал - минимум чтобы получить зачет
...
4. **Автор** - это сущность для хранения людей или того кто выпускает журнал
    - Полное имя (это "Лев Толстой" для книг или например "Редакция" для журналов)
    - Год рождения (создания)
...
6. **Библиотека**
   - Хранит список читателей
   - Хранит список книг и журналов
   - Хранит список авторов
   - Заправляет основной логикой библиотеки (добавляет книги/ищет/печатает и тд)
